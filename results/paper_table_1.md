...
|  |  Ablated (no fire) | 2.80 | 0.950 | +73.6% |
| **** | ** Full (ours)** | **2.81** | **0.935** | **+73.5%** |
| 12h | Persistence | 14.30 | -0.362 | --- |
|  | Climatology | 19.47 | -0.920 | -36.2% |
|  |  Ablated (no fire) | 5.32 | 0.808 | +62.8% |
| **** | ** Full (ours)** | **5.37** | **0.764** | **+62.4%** |
| 24h | Persistence | 9.97 | 0.468 | --- |
|  | Climatology | 15.14 | -0.176 | -51.9% |
|  |  Ablated (no fire) | 7.21 | 0.721 | +27.7% |
| **** | ** Full (ours)** | **7.20** | **0.626** | **+27.8%** |
| 48h | Persistence | 12.84 | 0.159 | --- |
|  | Climatology | 14.84 | -0.140 | -15.6% |
|  |  Ablated (no fire) | 8.45 | 0.633 | +34.2% |
| **** | ** Full (ours)** | **8.50** | **0.513** | **+33.8%** |
